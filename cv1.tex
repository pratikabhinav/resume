...
{\bodytext{Built a Pomodoro timer to improve productivity using HTML, Bootstrap, jQuery. Also created a versatile \textbf{Chrome extension} for the same project. Apart from being a Pomodoro timer, the extension also has options for a custom timer and a 50-10 timer.}}
