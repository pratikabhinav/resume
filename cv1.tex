...
{\bodytext{A micro blog with trending posts and upvotes feature for the students of my college that would them stay in touch with all the events in the entire University. The project was developed using MEAN stack. }}
...
\item \headedsubsection  % sets the header for the section and includes any subsections
  {{\normalfont My \textbf{GitHub} }}{{{GitHub}}}
...
{\bodytext{\textbf{Others}:~SQL, Python, Git, \LaTeX. HTML, CSS, Javascript, Angular, jQuery, Bootsrap, Ionic, Cordova, MEAN stack, Wordpress  }}
...
\item \headedsubsection
{A Real-Time Social Blog}{{{College minor project}}}
{\bodytext{A micro blog with trending posts and upvotes feature for the students of my college that would them stay in touch with all the events in the entire University. The project was developed using MEAN stack. }}
...
>>>>>>> 35cbcad21389e52340908e9ced9cb279f668107c
\end{document}