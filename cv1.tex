...
\headedsection  % sets the header for the section and includes any subsections
  ...
  {\textbf{\textsc{Google Summer of Code Project}}}
  {%
  \headedsubsection
    ...
    {\bodytext{
    \begin{itemize}
    \item For my GSoC 2017 project proposal, I implemented an Interactive web tour across cBioPortal, that guides users through the different features of the website and explains with an easy step-by-step procedure, how to use them. Although this was a significant project and was appreciated by the mentors, due to lack of resources they could not go forward with it. You can find the entire project proposal on \href{https://github.com/pratikabhinav/GSoC-cBioPortal}{GitHub}.\\
    \end{itemize}
}}
}
\spacedhrule{0.5em}{-0.4em}
...
{\bodytext{Chord is a protocol and algorithm for a peer-to-peer distributed hash table. I implemented the algorithm as described in section 4 of this \href{https://pdos.csail.mit.edu/papers/chord:sigcomm01/chord_sigcomm.pdf}{research paper} using Elixir, which is a functional programming language designed with concurrency in mind.}}

\item \headedsubsection
{A Gossip Simulator}{{{October~'18}}}
{\bodytext{I implemented gossip and push sum algorithms and observed its behavior for various network topologies. Topologies implemented were : Full, 3D, Random 2D, Imperferct 2D, Line and Imperfect line. The project was written in Elixir.}}
...
\spacedhrule{0.5em}{-0.4em}
\roottitle{Skills}
{\bodytext{\textbf{Programming Languages}:~C/C++, Java, Golang, Elixir}}
